-- Add index to users table to improve performance on queries filtering by userId
...
-- Add index to marketdata table to improve performance on queries filtering by instrumentId and date
